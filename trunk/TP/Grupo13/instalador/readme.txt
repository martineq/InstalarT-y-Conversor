...
3. Finalizada la instalación, se creará en el directorio "grupo13" la estructura elegida por el usuario en "instalarT".

4. Debido al uso del script "desempaquetar.sh" para descomprimir todos los archivos necesarios para el funcionamiento del programa, se hace uso de los comandos "gunzip" y "tar", los mismos deben encontrarse disponibles para obtener la carpeta de instalación.

5. Una vez completo el proceso de instalación el primer comando a ejecutar para corree el programa es "IniciarT"
